...
## [](https://github.com/payloadbox/command-injection-payload-list#what-is-os-command-injection)What is OS command injection?
...
## [](https://github.com/payloadbox/command-injection-payload-list#description-)Description :
...
## [](https://github.com/payloadbox/command-injection-payload-list#remediation)Remediation:
...
### [](https://github.com/payloadbox/command-injection-payload-list#unix-)Unix :
...
### [](https://github.com/payloadbox/command-injection-payload-list#windows-)Windows :
...
#### [](https://github.com/payloadbox/command-injection-payload-list#references-)References :

###### [](https://github.com/payloadbox/command-injection-payload-list#testing-for-command-injection-otg-inpval-013)Testing for Command Injection (OTG-INPVAL-013)
...
###### [](https://github.com/payloadbox/command-injection-payload-list#owasp-command-injection)OWASP Command Injection

-   👉 [https://www.owasp.org/index.php/Command_Injection](https://www.owasp.org/index.php/Command_Injection)

###### [](https://github.com/payloadbox/command-injection-payload-list#we-77-improper-neutralization-of-special-elements-used-in-a-command-command-injection)WE-77: Improper Neutralization of Special Elements used in a Command ('Command Injection')

-   👉 [http://cwe.mitre.org/data/definitions/77.html](http://cwe.mitre.org/data/definitions/77.html)

###### [](https://github.com/payloadbox/command-injection-payload-list#we-78-improper-neutralization-of-special-elements-used-in-an-os-command-os-command-injection)WE-78: Improper Neutralization of Special Elements used in an OS Command ('OS Command Injection'

-   👉 [http://cwe.mitre.org/data/definitions/78.html](http://cwe.mitre.org/data/definitions/78.html)

###### [](https://github.com/payloadbox/command-injection-payload-list#portswigger-web-security---os-command-injection)Portswigger Web Security - OS Command Injection
...
### [](https://github.com/payloadbox/command-injection-payload-list#cloning-an-existing-repository--clone-with-https-)Cloning an Existing Repository ( Clone with HTTPS )

```
root@ismailtasdelen:~# git clone https://github.com/ismailtasdelen/command-injection-payload-list.git
```

### [](https://github.com/payloadbox/command-injection-payload-list#cloning-an-existing-repository--clone-with-ssh-)Cloning an Existing Repository ( Clone with SSH )
